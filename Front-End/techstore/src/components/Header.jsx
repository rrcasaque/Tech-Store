    ...
    return (
        <>
            <header className='headerStyle'>
                <a className='logoStyle' onClick={(e) => { e.preventDefault(); props.padrao();props.mudarEstado(false)}} href="##"><img className='nomeStyle' src={Logo} alt="logo da página" />
                ...
                <div style={botoes} className='containerLinks'>
                    <a href="##" onClick={(e) => { e.preventDefault(); props.conta();props.mudarEstado(!props.estado)}}>
                    ...
                    <a href="##" onClick={(e) => { e.preventDefault(); props.dados();props.mudarEstado(!props.estado)}}>
                        <span className='links'>
                    ...
                    <a href="##" onClick={(e) => { e.preventDefault(); props.compra();props.mudarEstado(!props.estado)}}>
                        <span className='links'>
                ...
                <a href="##" className="shoppingCar" onClick={(e) => { e.preventDefault(); props.carrinho();props.mudarEstado(false)}}><div>
            ...
            <nav className='menu2' style={menu2}>
                ...
                <div>
                    <a className="m-tb-5" href="##" onClick={(e)=>{e.preventDefault(); props.logar();props.mudarEstado(!props.estado)}}>Login</a>
                    <a className="m-tb-5" href="##" onClick={(e)=>{e.preventDefault(); props.cadastrar();props.mudarEstado(!props.estado)}}>Cadastro</a>
                </div>
            </nav>
        </>
    )
