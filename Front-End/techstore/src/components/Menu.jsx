...
export default function Menu(props) {    
    ...
    return (
        <nav style={navStyle} id="navMenu" className={props.estado?"menuAberto":"menuFechado"}>
            <h2 style={h2Style}>Olá! Faça seu login.</h2>
            <ul style={ulStyle}>
                <a href="##" style={aStyle} onClick={(e)=>{e.preventDefault(); props.conta();props.mudarEstado(!props.estado)}}><li className="m-tb-15">
                ...
                <a href="##" style={aStyle} onClick={(e)=>{e.preventDefault(); props.dados();props.mudarEstado(!props.estado)}}><li className="m-tb-15">
                ...
                <a href="##" style={aStyle} onClick={(e)=>{e.preventDefault(); props.compras();props.mudarEstado(!props.estado)}}><li className="m-tb-15">
            ...
            <a className="m-tb-5 btn-l" style={botaoStyle} href="##" onClick={(e)=>{e.preventDefault(); props.logar();props.mudarEstado(!props.estado)}}>Login</a>
            <a className="m-tb-5 btn-c" style={botaoStyle} href="##" onClick={(e)=>{e.preventDefault(); props.cadastrar();props.mudarEstado(!props.estado)}}>Cadastro</a>
        </nav>
    )
}